...
def get_filters():
    ...
    # To filter by each condition if both/month/day/none    
            ...
            if filter_choice == 'both':
                ...
                while True:
                    day = input("\nWhich day (e.g. Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, all)?")
                    if month.lower() not in ('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'all'):
                        print("Sorry, I didn't catch that. Try again.")
                        continue
                    else:
                        break
